...
{
    wheelControls.rotateClockwise(65, 250);
    delay(20);
    ...
    delay(20);
    wheelControls.moveBackwardEncoders(8, 100);
    delay(20);
    robotArmControl.updatePosition("sweep");
    delay(20);
...
void everythingElse()
{
    ...
    wheelControls.moveBackwardEncoders(17.0, 200);
    delay(20);
    ...
    wheelControls.rotateClockwise(75, 250);
    delay(20);
