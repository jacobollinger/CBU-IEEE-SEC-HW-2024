...
void setup()
{
    ...
    while (!startButton.armed() && input != "arm")
    {
        ...
        Logger::log(startButton.isPressed());
        delay(1000);
        if (Serial.available())
        {
...
void collectLargePackages()
{
    ...
    robotArmControl.solveIK(-16.5, 13.5, -3);
    robotArmControl.updatePosition("largePackage");
}
