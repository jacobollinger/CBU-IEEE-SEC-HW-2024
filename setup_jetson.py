...
subprocess.check_call(["sudo", "apt", "install", "libopenblas-base", "libopenmpi-dev", "libomp-dev"])
...
subprocess.check_call(["pip3", "install", "Cython<3", "numpy", "torch-2.1.0-cp310-cp310-linux_aarch64.whl"])
os.chdir("vision")
